...
def convert_glb_to_3dm(glb_path, output_3dm_path, unityAxisFormat):
    """
...
def Generate(glb_file_path, unityAxisFormat):
    ...
    # --- Run the conversion ---
    try:
        convert_glb_to_3dm(glb_file_path, output_3dm_file_path, unityAxisFormat)
